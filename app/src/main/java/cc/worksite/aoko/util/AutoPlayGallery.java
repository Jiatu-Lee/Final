...
public class AutoPlayGallery extends RelativeLayout {
    ...
    private void setupContentView(Context context) {
        pointBg = BitmapFactory.decodeResource(getResources(), R.drawable.dot_select);
        pointPressedBg = BitmapFactory.decodeResource(getResources(), R.drawable.dot_nor);
    ...
    private void setIndicator(Context context, int size) {
        for (int i = 0; i < size; i++) {
            ...
            point.setImageResource(R.drawable.dot_nor);
